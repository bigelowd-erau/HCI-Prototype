...
public class UnderBarrelSelector : MonoBehaviour
{
   ...
   Color activePanelColor = new Color(0f, 0.9372549019607843f, 1f);
    ...
    public void Start()
    {
        GunCustSelectionPublisher.SelectUnderBarrel.AddListener(Select);
        Select("1");
    }
    ...
    {
        GunCustSelectionPublisher.SelectUnderBarrel.RemoveListener(Select);
    }
}
